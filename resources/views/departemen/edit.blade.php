                        ...
                        <form action="{{ route('departemen.update',$departemen->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('nama_manager') is-invalid @enderror" name="nama_manager" value="{{ old('nama_manager',$departemen->nama_manager) }}" placeholder="Masukkan Nama Manager"> @error('nama_manager')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
